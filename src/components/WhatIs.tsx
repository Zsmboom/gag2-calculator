    ...
    <section id="what-is" className="section bg-white dark:bg-gray-900">
      <div className="container">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Looking for creative tools for your gaming content? Check out <a href="https://www.framegenai.com/" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium">FrameGenAI</a>, an AI Image and Video Generation Platform that can help you create stunning visuals for your gameplay.
          </p>
          <div className="mt-8">
            <a 
