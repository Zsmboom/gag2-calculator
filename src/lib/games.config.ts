...
export const defaultConfig: GameSiteConfig = {
  ...
  seo: {
    ...
    siteDescription:
      "Free Grow a Garden 2 calculator, active GAG2 codes, 38-crop seed database, NPC guides, mutation multipliers, and complete Roblox GAG2 wiki for 2026.07.",
  ...
  pages: [
    { path: "/", title: "grow-a-garden-2 calculator[2026.07]", description: "Free Grow a Garden 2 calculator, active GAG2 codes, 38-crop seed database, NPC guides, mutation multipliers, and complete Roblox GAG2 wiki for 2026.07.", priority: 1.0, isHub: true },
    ...
    { path: "/guide", title: "Guide", description: "Grow a Garden 2 Beginner Guide", priority: 0.8, isHub: true },
    { path: "/systems", title: "Systems", description: "Grow a Garden 2 Game Systems", priority: 0.85, isHub: true },
    { path: "/systems/seeds", title: "Seeds", description: "Grow a Garden 2 38-Crop Seed Database", priority: 0.8, isHub: true },
