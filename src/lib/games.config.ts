...
export const defaultConfig: GameSiteConfig = {
  ...
  pages: [
    ...
    { path: "/crops", title: "Crops", description: "Grow a Garden 2 36-Crop Database", priority: 0.7 },
    { path: "/mutations", title: "Mutations", description: "Grow a Garden 2 Mutation Multipliers", priority: 0.7 },
    { path: "/pets", title: "Pets", description: "Grow a Garden 2 Pet Catalog", priority: 0.7 },
    ...
    { path: "/offline-growth", title: "Offline Growth", description: "Grow a Garden 2 Offline Farming", priority: 0.5 },
    { path: "/secret-update", title: "gag.gg Features", description: "Official gag.gg Website Features Guide", priority: 0.5 },
  ...
  calculator: {
    ...
    dataFile: "items.json",
    logicDescription:
      "Sell Value = Base Value (1kg) × Weight² × Mutation Multiplier × (1 + Friend Boost%) × Quantity. Mutations are mutually exclusive in GAG2 — only one applies per crop. Values are community-estimated.",
  },
  features: [
    {
      title: "Active Codes",
